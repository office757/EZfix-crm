-- Harden marketing OAuth storage boundaries before provider callbacks are enabled.
...
$$ select private.store_marketing_oauth_secret_internal(p_name,p_secret) $$;
...
returns text language sql security invoker set search_path = '' as
$$ select private.get_marketing_oauth_secret_internal(p_ref) $$;
